    ...
    boolean doLoadOnWait() {
        if (mStatus == STATUS_WAITING) {
            ...
            if (mQueue.getRequestQueue() != null) {
                ...
                Log.d("SKYunLibrary", "must call be DownloadTaskQueue.setRequestQueue()");
            }
            return true;
        } else {
            return false;
