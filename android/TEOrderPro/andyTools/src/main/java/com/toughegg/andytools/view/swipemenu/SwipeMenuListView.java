...
public class SwipeMenuListView extends ListView {
        ...
        super.setAdapter(new SwipeMenuAdapter(getContext(), adapter) {
            ...
            public void onItemClick(SwipeMenuView view, SwipeMenu menu, int index) {
                ...
                if (mOnLeftItemClickListener != null) {
                    flag = mOnLeftItemClickListener.onLeftItemClick(view.getPosition(), menu, index);
                }
    ...
    public void setOnItemClickListener(OnItemClickListener listener) {
        ...
        Log.d("hcc", "is setOnItemClickListener-->>>>touche down");
    }
    ...
    public void setmOnLeftItemClickListener(OnLeftItemClickListener mOnLeftItemClickListener) {
        this.mOnLeftItemClickListener = mOnLeftItemClickListener;
    }
    ...
    public static interface OnLeftItemClickListener {
        boolean onLeftItemClick(int position, SwipeMenu menu, int index);
    }
