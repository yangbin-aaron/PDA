...
import com.toughegg.andytools.http.method.ByteArrayPool;
import com.toughegg.andytools.http.method.PoolingByteArrayOutputStream;
...
public class HttpUtils {
     ...
     * @throws IOException
     */
    public static byte[] responseToBytes(HttpResponse response) throws IOException, SKYunHttpException {
        ...
        try {
            ...
            if (in == null) {
                throw new SKYunHttpException("服务器连接异常");
            }
