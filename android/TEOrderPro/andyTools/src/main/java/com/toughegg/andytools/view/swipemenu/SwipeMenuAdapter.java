...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    private SwipeMenuListView.OnLeftItemClickListener onLeftItemClickListener;
    ...
    public void onItemClick(SwipeMenuView view, SwipeMenu menu, int index) {
        if (onLeftItemClickListener != null) {
            onLeftItemClickListener.onLeftItemClick(view.getPosition(), menu,
                    index);
        }
    }

    public void setOnSwipeItemClickListener(
            SwipeMenuListView.OnLeftItemClickListener onLeftItemClickListener) {
