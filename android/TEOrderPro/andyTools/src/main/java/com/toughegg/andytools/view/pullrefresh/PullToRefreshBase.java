...
package com.toughegg.andytools.view.pullrefresh;
...
import com.toughegg.andytools.view.pullrefresh.internal.FlipLoadingLayout;
import com.toughegg.andytools.view.pullrefresh.internal.LoadingLayout;
import com.toughegg.andytools.view.pullrefresh.internal.RotateLoadingLayout;
import com.toughegg.andytools.view.pullrefresh.internal.Utils;
import com.toughegg.andytools.view.pullrefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void callRefreshListener() {
		Log.d("hcc","callRefreshListener--->>>>>");
		if (null != mOnRefreshListener) {
			mOnRefreshListener.onRefresh(this);
		} else if (null != mOnRefreshListener2) {
			if (mCurrentMode == Mode.PULL_FROM_START) {
				Log.d("hcc","callRefreshListener--->>>>>PULL_FROM_START");
				mOnRefreshListener2.onPullDownToRefresh(this);
			} else if (mCurrentMode == Mode.PULL_FROM_END) {
				Log.d("hcc","callRefreshListener--->>>>>PULL_FROM_END");
